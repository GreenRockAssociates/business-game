 ...
 * @param type The name of the DTO to parse to
 * @param skipMissingProperties
 */
export function jsonToDtoMiddlewareFactory(type: any, skipMissingProperties = false){
    return async (req: Request, res: Response, next: NextFunction) => {
        const dto = plainToInstance(type, req.body, { excludeExtraneousValues: true });
